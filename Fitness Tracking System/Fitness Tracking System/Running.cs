...
namespace Fitness_Tracking_System
{
    public partial class Running : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            int.TryParse(txtSpeed.Text, out int time) &&
            ...
            {
                MessageBox.Show("Please enter valid numeric values for Steps, Distance, Speed, and Goal.");
            }
        }
        ...
        private void InsertNewGoal(double caloriesBurned, int goal)
        {
            using (OleDbConnection conn = new OleDbConnection(connectionString))
            {
                ...
                string query = "INSERT INTO Goals (Username, ActivityType, Goal, AchievedGoal, Metric1, Metric2, Metric3) " +
                               "VALUES (@Username, 'Running', @Goal, @caloriesBurned, @Steps, @Distance, @Speed)";
